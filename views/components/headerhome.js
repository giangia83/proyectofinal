...
function createHeader(usuario) {
  ...
  // Añadir botón de administración si el usuario es administrador
  if (usuario && usuario.esAdmin) {
      centerSection += `
        <a href="/administrar" class="btn btn-special btn-center" type="button" aria-expanded="false">Administrar</a>
      `;
  }

  centerSection += `</div>`; // Cierra la sección central del encabezado
    ...
    <div class="header-right">
      ...
      <div class="menu-desplegable" id="menuDesplegable">
        <ul>
          ...
          ${usuario && usuario.esAdmin ? `<li><a href="/administrar">Administrar</a></li>` : ''}
        </ul>
      </div>
    </div>
  `;
